...
public interface ImmutableList {
    ...
    ImmutableList add(String e); //додає елемент у кінець колекції

    ImmutableList add(int index, String e); //додає елемент до колекції за індексом, та кидає виключну ситуацію, якщо індекс виходить за межі колекції
